...
#ifndef NDEBUG
inline void draw_transform_component_editor(TransformComponent& component, const char* label) {
    ...
    if (ImGui::DragFloat3("Rotation (Degrees)", glm::value_ptr(euler_angles_deg))) {
