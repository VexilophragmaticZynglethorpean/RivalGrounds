...
App::init()
{
  ...
  m_window.m_raw_window = glfwCreateWindow(m_window.m_dimensions.x,
...
App::update_delta_time()
{
  ...
  m_delta_time = static_cast<float>(m_current_frame_time - m_last_frame_time);
