...
PhysicsComponent& PhysicsComponent::apply_force(const glm::vec3& force) {
    m_total_force += force;
    return *this;
}

PhysicsComponent& PhysicsComponent::apply_force_at_point(const glm::vec3& force, const glm::vec3& center_of_mass, const glm::vec3& apply_point) {
    m_total_force += force;
...
PhysicsComponent& PhysicsComponent::apply_linear_impulse(const glm::vec3& impulse) {
    m_linear_momentum += impulse;
    return *this;
}

PhysicsComponent& PhysicsComponent::integrate(float fixed_step) {
...
const glm::vec3& PhysicsComponent::get_velocity() const { return m_velocity; }
const glm::vec3& PhysicsComponent::get_angular_velocity() const { return m_angular_velocity; }
float PhysicsComponent::get_mass() const { return m_mass; }
bool PhysicsComponent::has_gravity() const { return m_has_gravity; }
