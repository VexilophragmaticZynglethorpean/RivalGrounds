...
private:
  ...
  // void
  // setup_cube(const SceneObjectStrongPtr& cube)
  // {
  ...
  //               self->get_world_transformation_mat()); packet->mesh->draw();
  //             }
  //           });
  //       }
  //     });
  ...
  // void
  // setup_frustum(const SceneObjectStrongPtr& frustum)
  // {
  ...
  // void
  // setup_objmodel(const SceneObjectStrongPtr& objmodel)
  // {
  ...
  //                                      { "AABB.vert.glsl", "AABB.frag.glsl"
  //                                      });
  //         packet->mesh->template load<Vertex_Pos,
  //         TriangleIndices>("cube.obj",
  //                                                                  GL_TRIANGLES);
